...
class category extends Component{
	...
	render() {
		return (
		 <div className="col-lg-6 col-md-6 col-sm-6" style={{marginBottom:"20px"}}> <h4>{this.props.category} : <span className="label label-primary" id={this.props.category}>50</span> </h4>
